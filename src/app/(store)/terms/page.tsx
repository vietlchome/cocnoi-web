...
function FallbackContent() {
  return (
    <>
      ...
      <section>
        <h2 className="font-playfair text-xl font-bold text-primary mb-3">4. Trách nhiệm B2B và Wholesale</h2>
        <p>
...
export default async function TermsOfServicePage() {
  const page = await PageService.getPageBySlugPublic("terms").catch(() => null);
