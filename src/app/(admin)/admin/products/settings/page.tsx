...
export default async function AdminCategoriesPage() {
  ...
  const [categories, productGroups, sizes, colors, finishes] = await Promise.all([
    ...
    <div className="w-full flex flex-col gap-6">
      <div className="flex flex-col gap-1">
        ...
        <p className="font-bvp text-xs text-secondary">
          Quản lý tập trung Danh mục, Bộ sưu tập, Kích cỡ (Size), Màu sắc và Kỹ thuật Hoàn thiện hiển thị ở cửa hàng.
        </p>
      </div>
